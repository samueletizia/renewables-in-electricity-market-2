...
SIX_FOUR_TWO= Model(Gurobi.Optimizer)


@variable(SIX_FOUR_TWO, power_DA[1:T]>=0)

@variable(SIX_FOUR_TWO, delta[1:T,1:O])          
@variable(SIX_FOUR_TWO, delta_more[1:T,1:O]>=0)  
@variable(SIX_FOUR_TWO, delta_less[1:T,1:O]>=0) 
@variable(SIX_FOUR_TWO, epsi)
@variable(SIX_FOUR_TWO, mi[1:O]>=0)     

@objective(SIX_FOUR_TWO, Max, sum(prob_in[o]*(scenarios_200[t,DA_price,o]*power_DA[t] 
...
) for t=1:T, o=1:O) + beta[B]*(epsi - 1/(1-alpha)*sum(prob_in[o]*mi[o] for o=1:O)))
...
@constraint(SIX_FOUR_TWO,[t=1:T], power_DA[t]<=wind_farm_CAP)
@constraint(SIX_FOUR_TWO, [t=1:T,o=1:O], delta_more[t,o] - delta_less[t,o] == scenarios_200[t,DA_wind,o] - power_DA[t])
...
@constraint(SIX_FOUR_TWO,[o=1:O],-sum(scenarios_200[t,DA_price,o]*power_DA[t] 
